...
exports.reslinkRouter.get('/', async (req, res) => {
    try {
...
exports.reslinkRouter.get('/:id', async (req, res) => {
    try {
...
exports.reslinkRouter.post('/', async (req, res) => {
    try {
...
exports.reslinkRouter.put('/:id', async (req, res) => {
    try {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            return res.status(400).json({
...
exports.reslinkRouter.delete('/:id', async (req, res) => {
    try {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            return res.status(400).json({
