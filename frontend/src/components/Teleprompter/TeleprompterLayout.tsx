...
export const TeleprompterLayout: React.FC<TeleprompterLayoutProps> = ({ 
  script = '', 
  onExit = () => {},
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 flex items-center justify-center bg-muted/30 p-8">
          <div className="relative">
            {/* Main Video Window */}
            <Card className="w-[600px] h-[400px] p-0 overflow-hidden shadow-2xl">
                        ...
                        <div className="overflow-hidden relative w-full h-full">
                          <div
                            className={`text-white leading-relaxed font-bold text-center ${
                              ...
                              settings.fontSize === 'medium' ? 'text-xl' : 'text-2xl'
                            }`}
                            style={{ 
                          ...
                          >
                            ...
                            {script.split('\n').map((paragraph, index) => (
                              <p key={index} className="mb-6 leading-tight max-w-3xl mx-auto">
                                {paragraph}
                              </p>
                            ))}
                          </div>
        ...
        <div className="w-[300px] border-l bg-card flex flex-col shadow-lg">
          <div className="p-4 border-b">
            {hasRecording ? (
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Review Recording</h3>
          ...
          <div className="flex-1 p-4 overflow-y-auto">
            {hasRecording ? (
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-base font-medium mb-3 block">Recording Details</Label>
                  <Card className="p-3">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    <ul className="mt-2 text-sm space-y-1">
                      <li>• Watch your recording</li>
                      <li>• Upload if satisfied</li>
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-base font-medium mb-3 block">Your Script</Label>
                  <Card className="p-3">
                    <textarea
                      value={script}
                      readOnly
                      className="w-full h-32 resize-none border-none bg-transparent text-sm leading-relaxed focus:outline-none"
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <Label className="text-base font-medium">Controls</Label>
                  </div>
